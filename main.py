...
# ===============================
# GitHub Secrets에서 봇 토큰만 불러오고, 채널 아이디는 직접 입력
...
# 2️⃣ 네이버 '가장 많이 본 뉴스' URL
URL = "https://news.naver.com/main/ranking/popularDay.naver"

def get_news():
    """네이버 인기뉴스 페이지에서 21개 언론사 기사만 필터링"""
...
def format_message(news_list):
    ...
    for press_name in TARGET_PRESS:
        ...
        if articles:
            message += f"\n<b>[{press_name}]</b>\n"
            for article in articles[:2]:  # 언론사당 최대 2개
